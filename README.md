...
failureDisplayFormat=io.github.milczekt1.llamarules.rules.format.AgentFriendlyFailureDisplayFormat
...
freeze.store=io.github.milczekt1.llamarules.rules.freeze.EmptyOmittingViolationStore
```
...
`freeze.store=io.github.milczekt1.llamarules.rules.freeze.EmptyOmittingViolationStore` keeps the index
