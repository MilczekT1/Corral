...
freeze.store=io.github.milczekt1.llamarules.freeze.EmptyOmittingViolationStore
```
...
`freeze.store=io.github.milczekt1.llamarules.freeze.EmptyOmittingViolationStore` keeps the index
